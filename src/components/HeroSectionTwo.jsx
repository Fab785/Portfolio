...
const HeroSectionTwo = () => {
  return (
    <section className="w-full min-h-screen bg-[#1a1a1a] text-white flex flex-col justify-center items-center px-6 md:px-20 py-20">
      <div className="max-w-7xl w-full flex flex-col md:flex-row justify-between items-center gap-16">
        ...
        <div className="flex-1 flex justify-center items-center">
          <div className="w-[300px] md:w-[400px] aspect-[3/4] bg-gray-500 rounded-2xl transform rotate-6 shadow-xl">
            {/* Placeholder image area. Replace with <img src={yourImage} ... /> */}
          </div>
        </div>
      </div>
    </section>
